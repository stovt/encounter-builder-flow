...
import type { MonstersBase, Monster } from 'shared/types/monsters';
...
export const addMonsterToGroup = (
  ...
  type: ADD_MONSTER_TO_GROUP, monsterID, monster
});
export const addMonsterToGroupSuccess = (monsterID: string): EncounterBuilderAction => ({
  type: ADD_MONSTER_TO_GROUP_SUCCESS, monsterID
});
